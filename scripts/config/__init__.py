...
AWS_PRIO_VAR="PRIO" # Name of Lambda Functions Tag that yields the function's priority
...
AWS_DISCOVERED_VAR="ZBXdiscovered" # Name of Lambda Tag that specifies the function is discovered in Zabbix
